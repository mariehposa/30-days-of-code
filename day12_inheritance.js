    ...
    */
    ...
    calculate() {
        ...
        for(var i = 0; i < this.testScores.length; i++){
            grade_sum += this.testScores[i] 
        }
        let average_grade = grade_sum / this.testScores.length;

        if(average_grade < 40){
            return 'T';
        } else if(average_grade >= 40 && average_grade < 55){
            return 'D';
        } else if(average_grade >= 55 && average_grade < 70){
            return 'P';
